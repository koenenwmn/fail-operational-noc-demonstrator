...
## Clock Signal
set_property -quiet -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_L13P_T2_MRCC_34 Sch=sysclk
...
set_property -quiet -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports -quiet { cpu_rst_n }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn
...
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { pmod_uart_cts }]; #IO_L24P_T3_34 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { pmod_uart_tx }]; #IO_L24N_T3_34 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { pmod_uart_rx }]; #IO_L23P_T3_34 Sch=jb_p[4]
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { pmod_uart_rts }]; #IO_L23N_T3_34 Sch=jb_n[4]
...
## UART
set_property -dict { PACKAGE_PIN AA19  IOSTANDARD LVCMOS33 } [get_ports { usb_uart_tx }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=uart_rx_out
set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33 } [get_ports { usb_uart_rx }]; #IO_L14P_T2_SRCC_14 Sch=uart_tx_in
...
## FMC FX3 pinout
# FX3: PCLK, FMC: G6, FPGA: K18
#set_property PACKAGE_PIN K18 [get_ports fx3_pclk]

# FX3: DQ0, FMC: H4, FPGA: J19
#set_property PACKAGE_PIN J19 [get_ports {fx3_dq[0]}]
# FX3: DQ1, FMC: H7, FPGA: M18
#set_property PACKAGE_PIN M18 [get_ports {fx3_dq[1]}]
# FX3: DQ2, FMC: H8, FPGA: L18
#set_property PACKAGE_PIN L18 [get_ports {fx3_dq[2]}]
# FX3: DQ3, FMC: H10, FPGA: N20
#set_property PACKAGE_PIN N20 [get_ports {fx3_dq[3]}]
# FX3: DQ4, FMC: H11, FPGA: M20
#set_property PACKAGE_PIN M20 [get_ports {fx3_dq[4]}]
# FX3: DQ5, FMC: H13, FPGA: M13
#set_property PACKAGE_PIN M13 [get_ports {fx3_dq[5]}]
# FX3: DQ6, FMC: H14, FPGA: L13
#set_property PACKAGE_PIN L13 [get_ports {fx3_dq[6]}]
# FX3: DQ7, FMC: H16, FPGA: L14
#set_property PACKAGE_PIN L14 [get_ports {fx3_dq[7]}]
# FX3: DQ8, FMC: H17, FPGA: L15
#set_property PACKAGE_PIN L15 [get_ports {fx3_dq[8]}]
# FX3: DQ9, FMC: H19, FPGA: L16
#set_property PACKAGE_PIN L16 [get_ports {fx3_dq[9]}]
# FX3: DQ10, FMC: H20, FPGA: K16
#set_property PACKAGE_PIN K16 [get_ports {fx3_dq[10]}]
# FX3: DQ11, FMC: H22, FPGA: A18
#set_property PACKAGE_PIN A18 [get_ports {fx3_dq[11]}]
# FX3: DQ12, FMC: H23, FPGA: A19
#set_property PACKAGE_PIN A19 [get_ports {fx3_dq[12]}]
# FX3: DQ13, FMC: H25, FPGA: E19
#set_property PACKAGE_PIN E19 [get_ports {fx3_dq[13]}]
# FX3: DQ14, FMC: H26, FPGA: D19
#set_property PACKAGE_PIN D19 [get_ports {fx3_dq[14]}]
# FX3: DQ15, FMC: H28, FPGA: B15
#set_property PACKAGE_PIN B15 [get_ports {fx3_dq[15]}]

# FX3: SLCS, FMC: G19, FPGA: G18
#set_property PACKAGE_PIN G18 [get_ports fx3_slcs_n]
# FX3: SLWR, FMC: G21, FPGA: F19
#set_property PACKAGE_PIN F19 [get_ports fx3_slwr_n]
# FX3: SLOE, FMC: G22, FPGA: F20
#set_property PACKAGE_PIN F20 [get_ports fx3_sloe_n]
# FX3: SLRD, FMC: G24, FPGA: E21
#set_property PACKAGE_PIN E21 [get_ports fx3_slrd_n]

# FX3: PKTEND, FMC: G30, FPGA: C14
#set_property PACKAGE_PIN C14 [get_ports fx3_pktend_n]

# FX3: A0, FMC: G37, FPGA: F14
#set_property PACKAGE_PIN F14 [get_ports {fx3_a[0]}]
# FX3: A1, FMC: G36, FPGA: F13
#set_property PACKAGE_PIN F13 [get_ports {fx3_a[1]}]

# FX3: FLAGA, FMC: G25, FPGA: D21
#set_property PACKAGE_PIN D21 [get_ports fx3_flaga_n]
# FX3: FLAGB, FMC: G27, FPGA: F16
#set_property PACKAGE_PIN F16 [get_ports fx3_flagb_n]
# FX3: FLAGC, FMC: G28, FPGA: E17
#set_property PACKAGE_PIN E17 [get_ports fx3_flagc_n]
# FX3: FLAGD, FMC: G31, FPGA: C15
#set_property PACKAGE_PIN C15 [get_ports fx3_flagd_n]

# FX3: COM_RST, FMC: C11, FPGA: M22
#set_property PACKAGE_PIN M22 [get_ports fx3_com_rst]
# FX3: LOGIC_RST, FMC: C10, FPGA: N22
#set_property PACKAGE_PIN N22 [get_ports fx3_logic_rst]

# FX3: PMODE0, FMC: D11, FPGA: M21
#set_property PACKAGE_PIN M21 [get_ports {fx3_pmode[0]}]
# FX3: PMODE1, FMC: D12, FPGA: L21
#set_property PACKAGE_PIN L21 [get_ports {fx3_pmode[1]}]
# FX3: PMODE2, FMC: D14, FPGA: H20
#set_property PACKAGE_PIN H20 [get_ports {fx3_pmode[2]}]

set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS12 } [get_ports { fx3_pclk }]; # FX3: PCLK, FMC: G6, FPGA: K18

set_property -dict { PACKAGE_PIN J19   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[0] }]; # FX3: DQ0, FMC: H4, FPGA: J19
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[1] }]; # FX3: DQ1, FMC: H7, FPGA: M18
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[2] }]; # FX3: DQ2, FMC: H8, FPGA: L18
set_property -dict { PACKAGE_PIN N20   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[3] }]; # FX3: DQ3, FMC: H10, FPGA: N20
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[4] }]; # FX3: DQ4, FMC: H11, FPGA: M20
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[5] }]; # FX3: DQ5, FMC: H13, FPGA: M13
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[6] }]; # FX3: DQ6, FMC: H14, FPGA: L13
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[7] }]; # FX3: DQ7, FMC: H16, FPGA: L14
set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[8] }]; # FX3: DQ8, FMC: H17, FPGA: L15
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[9] }]; # FX3: DQ9, FMC: H19, FPGA: L16
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[10] }]; # FX3: DQ10, FMC: H20, FPGA: K16
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[11] }]; # FX3: DQ11, FMC: H22, FPGA: A18
set_property -dict { PACKAGE_PIN A19   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[12] }]; # FX3: DQ12, FMC: H23, FPGA: A19
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[13] }]; # FX3: DQ13, FMC: H25, FPGA: E19
set_property -dict { PACKAGE_PIN D19   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[14] }]; # FX3: DQ14, FMC: H26, FPGA: D19
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS12 } [get_ports { fx3_dq[15] }]; # FX3: DQ15, FMC: H28, FPGA: B15

set_property -dict { PACKAGE_PIN G18   IOSTANDARD LVCMOS12 } [get_ports { fx3_slcs_n }]; # FX3: SLCS, FMC: G19, FPGA: G18
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS12 } [get_ports { fx3_slwr_n }]; # FX3: SLWR, FMC: G21, FPGA: F19
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS12 } [get_ports { fx3_sloe_n }]; # FX3: SLOE, FMC: G22, FPGA: F20
set_property -dict { PACKAGE_PIN E21   IOSTANDARD LVCMOS12 } [get_ports { fx3_slrd_n }]; # FX3: SLRD, FMC: G24, FPGA: E21

set_property -dict { PACKAGE_PIN C14   IOSTANDARD LVCMOS12 } [get_ports { fx3_pktend_n }]; # FX3: PKTEND, FMC: G30, FPGA: C14

set_property -dict { PACKAGE_PIN F14   IOSTANDARD LVCMOS12 } [get_ports { fx3_a[0] }]; # FX3: A0, FMC: G37, FPGA: F14
set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS12 } [get_ports { fx3_a[1] }]; # FX3: A1, FMC: G36, FPGA: F13

set_property -dict { PACKAGE_PIN D21   IOSTANDARD LVCMOS12 } [get_ports { fx3_flaga_n }]; # FX3: FLAGA, FMC: G25, FPGA: D21
set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS12 } [get_ports { fx3_flagb_n }]; # FX3: FLAGB, FMC: G27, FPGA: F16
set_property -dict { PACKAGE_PIN E17   IOSTANDARD LVCMOS12 } [get_ports { fx3_flagc_n }]; # FX3: FLAGC, FMC: G28, FPGA: E17
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS12 } [get_ports { fx3_flagd_n }]; # FX3: FLAGD, FMC: G31, FPGA: C15

set_property -dict { PACKAGE_PIN M22   IOSTANDARD LVCMOS12 } [get_ports { fx3_com_rst }]; # FX3: COM_RST, FMC: C11, FPGA: M22
set_property -dict { PACKAGE_PIN N22   IOSTANDARD LVCMOS12 } [get_ports { fx3_logic_rst }]; # FX3: LOGIC_RST, FMC: C10, FPGA: N22

set_property -dict { PACKAGE_PIN M21   IOSTANDARD LVCMOS12 } [get_ports { fx3_pmode[0] }]; # FX3: PMODE0, FMC: D11, FPGA: M21
set_property -dict { PACKAGE_PIN L21   IOSTANDARD LVCMOS12 } [get_ports { fx3_pmode[1] }]; # FX3: PMODE1, FMC: D12, FPGA: L21
set_property -dict { PACKAGE_PIN H20   IOSTANDARD LVCMOS12 } [get_ports { fx3_pmode[2] }]; # FX3: PMODE2, FMC: D14, FPGA: H20
